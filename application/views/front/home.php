<body class="fixed-header dashboard">
    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-header">
        <img src="<?php echo base_url('assets/img/logo_white.png')?>" alt="logo" class="brand" data-src="<?php echo base_url('assets/img/logo_white.png')?>" data-src-retina="assets/img/logo_white_2x.png" width="78" height="22">
                  ...
                  <div class="padding-15">
                    <div class="item-header clearfix">
                      <div class="thumbnail-wrapper d32 circular">
                        <img width="40" height="40" src="<?php echo base_url('assets/img/profiles/3x.jpg')?>" data-src="<?php echo base_url('assets/img/profiles/3.jpg')?>" data-src-retina="<?php echo base_url('assets/img/profiles/3x.jpg')?>" alt="">
                      </div>
